...
{
    /// <summary>
    /// SHA256 Hash Encryptor Class
    /// </summary>
    public class Sha256Encryptor : IDataEncryptor
    {
        ...
        /// </summary>
        public Sha256Encryptor(EncodingOptions options)
        {
            _encryptor = options;
        }
        ...
        public string EncodeString(string plane)
        {
            ...
            {
                var hash = sha256.ComputeHash(_encryptor.Encoding.GetBytes(plane));
